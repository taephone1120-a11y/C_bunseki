...
if generate_desc_btn:
    with st.spinner("🕵️‍♂️ 市場10選の作品ページから、紹介文を読み込んでいます（数秒かかります）..."):
        ...
        ・「かわいい」「きれい」だけで終わらず、買う理由がある
        ・高価格帯の商品は、素材の良さ、手間、希少性、長く使える理由が説明されている
        ・食品、美容、健康、天然石、アロマ、スピリチュアル系の商品では、効果効能を断定しすぎず、自然で信頼感のある表現にしている
        ...
        5. 使用シーン
        日常の中で実際に使っている姿が想像できるように書いてください。
        ...
        例：
        ・天然石：石の意味を「〜と言われています」とやわらかく表現
        ・花や動物モチーフ：象徴する雰囲気や贈り物としての意味を説明
        ・木材や革：経年変化や素材の風合いを説明
        ・布や刺繍：手仕事の温かみや柄の魅力を説明
        ・食品：味わい、食感、楽しみ方を説明

        ただし、健康・美容・運気・効果効能については断定しないでください。
        ...
        8. 注意点
        素材の個体差、色味、サイズ、金具、食品の保存方法、発送方法、訳あり部分など、
        購入前に知っておいた方がよいことを、信頼感のある言葉で入れてください。
