...
if 'candidate_items' in locals() and not candidate_items.empty:
    ...
    if generate_btn:
        with st.spinner("📝 AI用のプロンプトを作成中..."):
            ...
            「何の商品か」「素材は何か」「どんな場面で使えるか」「購入前の不安が解消されるか」が
            タイトル内で分かる商品の方が、検索にも購入にもつながりやすいです。

            そのため、タイトル作成では以下を必ず意識してください。

            ## 検索上位を狙う条件

            ・タイトルの前半に、検索されやすいメインキーワードを入れる
            ・商品カテゴリが一目で分かる言葉を必ず入れる
            　例：ネックレス、リング、ブレスレット、ピアス、バッグ、ポーチ、カード、ウェルカムボードなど
            ・素材名、色、デザイン特徴、用途、安心要素を自然に入れる
            ...
            ・使用シーンが分かる言葉を入れる
            　例：誕生日、母の日、父の日、結婚式、通勤、普段使い、お守り、ギフト、プレゼントなど
            ・購入前の不安を減らす言葉を入れる
            　例：金属アレルギー対応、サージカルステンレス、軽量、サイズ調整可、選べる、送料無料、ラッピング対応など
            ・高価格帯の商品は、素材の良さ、希少性、手仕事感、長く使える理由が伝わるようにする
            ・天然石やお守り系の商品では、効果を断定せず「お守り」「〜と言われる天然石」など自然な表現にする
            ...
            素材・色・形・サイズ・デザイン・雰囲気などに関する言葉を5〜10個出してください。

            ### 購入訴求キーワード

            ギフト、普段使い、季節、イベント、悩み解消、安心感につながる言葉を5〜10個出してください。
            ...
            例：
            ・天然石名＋商品カテゴリ｜お守り訴求＋普段使い
            ・商品カテゴリ＋素材｜ギフト用途＋安心要素
            ・色や雰囲気＋商品カテゴリ｜天然石名＋使用シーン
    ...
    st.info("検索結果がある場合のみ、タイトル作成用プロンプトを生成できます。")
...
if generate_desc_btn:
    with st.spinner("🕵️‍♂️ 市場10選の作品ページから、紹介文を読み込んでいます（数秒かかります）..."):
        ...
        ・冒頭3行で、商品の魅力と使用シーンが伝わる
        ・素材、サイズ、使い心地、ギフト対応など、購入前の不安を解消している
        ・おしゃれな世界観だけでなく、具体的な使用シーンが書かれている
        ・「かわいい」「きれい」だけで終わらず、買う理由がある
        ・高価格帯の商品は、素材の良さ、手間、希少性、長く使える理由が説明されている
        ・天然石やお守り系の商品は、効果を断定せず、自然で信頼感のある表現になっている
        ...
        人気商品の紹介文が、どのような順番で書かれているか分析してください。
        ...
        人気商品の紹介文の中から、購入意欲を高めている表現を抽出してください。
        ...
        「素敵だな」と思われるだけで終わらず、
        「今買いたい」と思ってもらうために必要な要素をまとめてください。

        ### 出品作品に取り入れるべき要素

        分析対象の人気商品から学び、
        今回の出品作品に取り入れるべき構成・言葉・訴求ポイントを具体的に教えてください。

        ---

        ## 2. 出品作品の魅力整理

        出品する作品情報をもとに、紹介文に入れるべき内容を整理してください。

        ### 作品の一番の魅力

        お客様に最初に伝えるべき魅力を1つに絞ってください。

        ### 想定される購入者

        この作品を買いそうな人を具体的に設定してください。

        例：
        ・普段使いできる天然石アクセサリーを探している人
        ・お守り感のあるアクセサリーが好きな人
        ・派手すぎない上品なアクセサリーを探している人
        ・自分へのご褒美を探している人
        ・大切な人へのギフトを探している人

        ### 購入者の悩み・願望

        購入者が心の中で感じていそうな悩みや願望を、
        日常のリアルな場面が想像できるように書いてください。

        ただし、不安を煽りすぎず、共感として自然に表現してください。

        ### 購入後の未来

        この作品を手にしたことで、
        お客様の日常がどのように少し良くなるのかを具体的に書いてください。

        例：
        ・朝の支度が少し楽しくなる
        ・手元を見るたびに気持ちが整う
        ・シンプルな服装にもさりげなく華やかさが出る
        ・自分を大切にするきっかけになる
        ・大切な人に気持ちが伝わるギフトになる

        ### 購入前の不安と解消ポイント

        お客様が購入前に気にしそうなことを整理し、
        紹介文の中でどう解消すればよいか提案してください。
        ...
        分析結果をもとに、出品ページにそのまま使える作品紹介文を3パターン作成してください。

        ### A. 検索キーワード重視

        Creemaやminneの検索に引っかかりやすいように、
        商品カテゴリ、素材名、用途、デザイン特徴を自然に入れた紹介文にしてください。

        ### B. 購入率重視

        お客様の悩み、願望、使用シーン、購入後の未来を丁寧に描き、
        「欲しい」「買いたい」と感じやすい紹介文にしてください。

        ### C. 世界観＋購入訴求バランス型

        作品の雰囲気や作家らしさを大切にしながら、
        素材、仕様、使用シーン、ギフト訴求もきちんと入れた紹介文にしてください。

        ---

        # 作品紹介文の構成ルール

        それぞれの紹介文は、以下の順番で作成してください。
        ...
        天然石の個体差、色味、サイズ、金具、アレルギー、訳あり部分など、
        購入前に知っておいた方がよいことを、信頼感のある言葉で入れてください。
        ...
        ・見出しには「◆ 〇〇〇 ◆」または「【〇〇〇】」を使う
        ・1〜2文ごとに空行を入れる
        ・文章を詰め込みすぎない
        ・区切り線には「───」を使う
        ・絵文字は使いすぎず、1セクションに0〜2個までにする
        ・使ってよい絵文字は、✨、💎、🌿、🎁、⚠️、📌 程度にする
        ・高級感や信頼感を損なうほど絵文字を多用しない
        ...
        最後に、この商品をCreemaやminneで検索してもらうためのキーワードを20個以上出してください。

        条件：
        ・スペース区切りで一覧化する
        ・商品と関係のある言葉だけにする
        ・本文に自然に入れられそうな言葉を優先する
        ・類語、言い換え、ターゲット層、季節、使用シーンも含める
        ・作品タイトルや作品説明文にすでに入っている言葉ばかりにしない
        ・誤解を招くキーワードは入れない
        ...
        最後に、作成した紹介文について以下をチェックしてください。

        ・冒頭3行で魅力が伝わるか
        ・検索キーワードが自然に入っているか
        ・購入前の不安が解消されているか
        ・使用シーンが具体的に想像できるか
        ・お気に入りだけで終わらず、購入理由があるか
        ・天然石の効果を断定していないか
        ・スマホで読みやすいか
        ・人気商品の文章をそのまま真似していないか
        """).strip()
